package com.forecast.weatherapplication.searchcitiesweather.views.adapters
...
class CitiesAdapter (activity: Activity) : RecyclerView.Adapter<CitiesAdapter.CitiesWeatherViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesWeatherViewHolder {
        val view: View = inflater!!.inflate(R.layout.item_city_weather, parent, false)
    ...
    class CitiesWeatherViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val imageWeather = view.ivWeatherIcon
        ...
        fun bind(cityWeather: CityWeather,activity: Activity) {
            ...
            cityName.text = cityWeather.city!!.name
